...
print_movie_title = print(movie_title)

print_single_movie_rating = print(movie_title + " " + movie_rating)

print_all_ratings = print("The movie" + " " + movie_title + " " + "has a great rating!")

default_movie_list = ("Back to the Future", "Blade", "Spirited Away")

title_or_ratings = int(input("Enter Number:"))
if title_or_ratings == 1:
    print("Movie Title:" + " " + movie_title)
elif title_or_ratings == 2:
    print("Movie Rating:" + " " + movie_rating)
elif title_or_ratings == 3:
    print(print_single_movie_rating)
